...
public class Vertice
{
    ...
    public Vertice() { }
    public Vertice(Vector3 vector) : this(vector.X, vector.Y, vector.Z) { }
    public Vertice(float x, float y, float z) => (X, Y, Z) = (x, y, z);
    ...
    public float[] ToArray() => new[] { X, Y, Z, ColorR, ColorG, ColorB, ColorA, TextureX, TextureY };
